...
class Qwen3VL:
    ...
    def preprocess_fn(self, input_data, fps=None):
        """
        Preprocess input data for Qwen3-VL using the native apply_chat_template.
        ...
        if self.mode == "img":
            ...
            # Expect a single caption string per sample when used inside BBScore
        ...
        # Convert HuggingFace BatchFeature into a generic dictionary so standard deep
        # neural extraction unpacking (**inputs) works.
